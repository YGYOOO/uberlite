...
,
    function(req,email, password, done) {
      db.findOneRider({ email: req.body.email }, function(err, user) {
...
router.post('/PriderLogin', function(req, res, next) {
passport.authenticate('local', function(err, user, info) {
  ...
  router.get('/PriderLogin', function(req, res, next) {
  passport.authenticate('local', function(err, user, info) {
...
router.get('/PriderLogout', function(req, res){
req.logout();
res.redirect('/');
});
