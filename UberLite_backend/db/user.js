...
var findOneUser= function(db,obj,callback){
  db.collection('user').findOne(obj,function(err,thing){
    db.close();
    if(thing){
      callback(null,thing);
    }
...
//check the one
module.exports.userFindOne = function(obj,callback){
